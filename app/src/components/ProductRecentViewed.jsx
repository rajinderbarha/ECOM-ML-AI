        ...
        <>
            <section className="  bg-pink-200  py-6">
                <div className="container mx-auto">
                    <h2 className="text-2xl font-bold mb-6">Products you have recently viewed</h2>
                    <div className=''>
                        <div className="flex justify-between align-center mb-4">
                            <h3 className="text-xl font-semibold ">Products you have recently viewed...</h3>
...
export default ProductRecentViewed;